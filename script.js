document.addEventListener('DOMContentLoaded', function() {
    const translations = {
        'pt': {
            ...
            'videosBlog.video1.title': 'Dia-a-dia New Works - Obras em Andamento',
            'videosBlog.video1.desc': 'Conheça um pouco do nosso trabalho diário e veja como transformamos espaços com qualidade e profissionalismo.',
            'videosBlog.video2.title': 'Projetos de Remodelação - Antes e Depois',
            'videosBlog.video2.desc': 'Veja a transformação completa de espaços através dos nossos projetos de remodelação em Vila do Conde e região.',
            'videosBlog.video3.title': 'Técnicas e Processos - New Works em Ação',
            'videosBlog.video3.desc': 'Conheça as técnicas e processos que utilizamos para garantir excelência em cada projeto de obras e remodelações.',
            'videosBlog.video4.title': 'Serviços Especializados - New Works',
            'videosBlog.video4.desc': 'Conheça nossos serviços especializados em pintura, pladur, pichelaria e muito mais em Vila do Conde e região.',
            'videosBlog.video5.title': 'Qualidade e Profissionalismo - New Works',
            'videosBlog.video5.desc': 'Veja como a New Works trabalha com qualidade, profissionalismo e compromisso em cada projeto de obras e remodelações.',
            'videosBlog.video6.title': 'Transformação de Espaços - New Works',
            'videosBlog.video6.desc': 'Descubra como transformamos espaços com excelência, utilizando materiais de alta qualidade e técnicas inovadoras.',
        ...
        'es': {
            ...
            'videosBlog.video1.title': 'Día a Día New Works - Obras en Curso',
            'videosBlog.video1.desc': 'Conozca un poco de nuestro trabajo diario y vea cómo transformamos espacios con calidad y profesionalismo.',
            'videosBlog.video2.title': 'Proyectos de Remodelación - Antes y Después',
            'videosBlog.video2.desc': 'Vea la transformación completa de espacios a través de nuestros proyectos de remodelación en Vila do Conde y región.',
            'videosBlog.video3.title': 'Técnicas y Procesos - New Works en Acción',
            'videosBlog.video3.desc': 'Conozca las técnicas y procesos que utilizamos para garantizar excelencia en cada proyecto de obras y remodelaciones.',
            'videosBlog.video4.title': 'Servicios Especializados - New Works',
            'videosBlog.video4.desc': 'Conozca nuestros servicios especializados en pintura, pladur, fontanería y mucho más en Vila do Conde y región.',
            'videosBlog.video5.title': 'Calidad y Profesionalismo - New Works',
            'videosBlog.video5.desc': 'Vea cómo New Works trabaja con calidad, profesionalismo y compromiso en cada proyecto de obras y remodelaciones.',
            'videosBlog.video6.title': 'Transformación de Espacios - New Works',
            'videosBlog.video6.desc': 'Descubra cómo transformamos espacios con excelencia, utilizando materiales de alta calidad y técnicas innovadoras.',
        ...
        'en': {
            ...
            'videosBlog.video1.title': 'New Works Daily Routine - Ongoing Projects',
            'videosBlog.video1.desc': 'Get to know a bit of our daily work and see how we transform spaces with quality and professionalism.',
            'videosBlog.video2.title': 'Remodeling Projects - Before and After',
            'videosBlog.video2.desc': 'See the complete transformation of spaces through our remodeling projects in Vila do Conde and surrounding areas.',
            'videosBlog.video3.title': 'Techniques and Processes - New Works in Action',
            'videosBlog.video3.desc': 'Discover the techniques and processes we use to ensure excellence in every construction and remodeling project.',
            'videosBlog.video4.title': 'Specialized Services - New Works',
            'videosBlog.video4.desc': 'Get to know our specialized services in painting, plasterboard, plumbing and much more in Vila do Conde and surrounding areas.',
            'videosBlog.video5.title': 'Quality and Professionalism - New Works',
            'videosBlog.video5.desc': 'See how New Works works with quality, professionalism and commitment in every construction and remodeling project.',
            'videosBlog.video6.title': 'Space Transformation - New Works',
            'videosBlog.video6.desc': 'Discover how we transform spaces with excellence, using high-quality materials and innovative techniques.',
